...
Write-Host "5. Create VM" -NoNewline
Write-Host "     6. Export VM" -NoNewline
Write-Host "     7. Import VM"

Write-Host "8. List vSwitches" -NoNewline
Write-Host "   9. Live Dashboard" -NoNewline
Write-Host "   10. Change Switch"

Write-Host "11. Create vSwitch" -NoNewline
Write-Host "   12. Delete vSwitch" -NoNewline
Write-Host "   15. Open VM Console"
